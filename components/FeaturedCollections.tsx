...
import { listFeaturedCollections } from '@/lib/content'

export default function FeaturedCollections() {
  const collections = listFeaturedCollections(4)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        ...
        <div className="group relative overflow-hidden cursor-pointer" style={{ aspectRatio: '4/5' }}>
          ...
          <div className="absolute bottom-0 left-0 p-8">
            ...
            <h3 className="font-serif text-3xl lg:text-4xl font-light text-white mt-2 mb-1">{collections[0].name}</h3>
        ...
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <div className="group relative overflow-hidden cursor-pointer flex-1" style={{ minHeight: '300px' }}>
            ...
            <div className="absolute bottom-0 left-0 p-8">
              ...
              <h3 className="font-serif text-3xl lg:text-4xl font-light text-white mt-2 mb-1">{collections[1].name}</h3>
            ...
            {collections.slice(2).map((col) => (
              <div key={col.id} className="group relative overflow-hidden cursor-pointer" style={{ aspectRatio: '1/1' }}>
                ...
                <div className="absolute bottom-0 left-0 p-5">
                  ...
                  <h3 className="font-serif text-xl font-light text-white mt-1 mb-1">{col.name}</h3>
                  <Link
                    href={col.href}
