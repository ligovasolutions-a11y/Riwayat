...
import { Crown, MapPin, Watch, Gem, Calendar, CheckCircle } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              <div className="bg-rw-black p-8">
                ...
                <p className="text-white/40 text-xs font-sans">123 Luxury Lane, Bandra West, Mumbai — 400050</p>
              </div>
            </div>
