...
const appointments = [
  { id: 1, name: 'Priya Mehta', phone: '+91 98765 43210', email: 'priya@email.com', type: 'Bridal Consultation', date: 'Dec 13, 2024', time: '3:00 PM', status: 'confirmed', message: 'Looking for complete bridal set under ₹5 lakhs' },
  { id: 2, name: 'Arjun Kapoor', phone: '+91 87654 32109', email: 'arjun@email.com', type: 'Watch Viewing', date: 'Dec 13, 2024', time: '5:00 PM', status: 'confirmed', message: 'Interested in Rolex Submariner' },
  { id: 3, name: 'Sanjay Patel', phone: '+91 76543 21098', email: 'sanjay@email.com', type: 'Jewellery Consultation', date: 'Dec 14, 2024', time: '11:00 AM', status: 'pending', message: 'Anniversary gift for wife, budget ₹2 lakhs' },
  { id: 4, name: 'Ritu Sharma', phone: '+91 65432 10987', email: 'ritu@email.com', type: 'Private VIP', date: 'Dec 14, 2024', time: '2:00 PM', status: 'pending', message: 'Would like to see new diamond collection' },
  { id: 5, name: 'Vikram Singh', phone: '+91 54321 09876', email: 'vikram@email.com', type: 'Boutique Visit', date: 'Dec 15, 2024', time: '4:00 PM', status: 'confirmed', message: '' },
]
    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 bg-white border border-gray-200 rounded-sm divide-y divide-gray-50">
          ...
          {filtered.length === 0 && <div className="p-12 text-center text-sm text-gray-400">No appointments found.</div>}
        </div>
